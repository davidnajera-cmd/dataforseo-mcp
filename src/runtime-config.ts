...
export const RUNTIME_VARIABLE_SPECS: RuntimeVariableSpec[] = [
  ...
  { name: "DNA_SITE_MX_EDU", group: "DNA Music", label: "GSC Mexico (dnamusic.edu.co)", description: "Propiedad GSC del subdominio mexico.dnamusic.edu.co.", sensitive: false, requiredFor: "GSC Mexico (subdominio)" },
  { name: "DNA_DOMAIN_MX_EDU", group: "DNA Music", label: "Dominio Mexico (dnamusic.edu.co)", description: "Dominio para DataForSEO: mexico.dnamusic.edu.co.", sensitive: false, requiredFor: "Competencia Mexico (subdominio)" },
  { name: "DNA_CANONICAL_URL_MX_EDU", group: "DNA Music", label: "URL canonica Mexico (dnamusic.edu.co)", description: "URL principal del subdominio para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_MX_EDU", group: "DNA Music", label: "Location code Mexico (dnamusic.edu.co)", description: "Codigo DataForSEO, por defecto el de Mexico.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_MX_EDU_PUBLISHED", group: "DNA Music", label: "Mexico (dnamusic.edu.co) publicado", description: "Pon 'false' solo si este subdominio deja de estar en produccion.", sensitive: false, requiredFor: "GSC Mexico (subdominio)" },
  { name: "GA4_PROPERTY_ID_MX_EDU", group: "GA4", label: "Property Mexico (dnamusic.edu.co)", description: "GA4 property ID para mexico.dnamusic.edu.co.", sensitive: false, requiredFor: "Reportes GA4 Mexico (subdominio)" },
  { name: "DNA_SITE_AR", group: "DNA Music", label: "GSC Argentina", description: "Propiedad GSC de argentina.dnamusic.edu.co.", sensitive: false, requiredFor: "GSC Argentina" },
  { name: "DNA_DOMAIN_AR", group: "DNA Music", label: "Dominio Argentina", description: "Dominio para DataForSEO: argentina.dnamusic.edu.co.", sensitive: false, requiredFor: "Competencia Argentina" },
  { name: "DNA_CANONICAL_URL_AR", group: "DNA Music", label: "URL canonica Argentina", description: "URL principal para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_AR", group: "DNA Music", label: "Location code Argentina", description: "Codigo DataForSEO para Argentina.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_AR_PUBLISHED", group: "DNA Music", label: "Argentina publicado", description: "Pon 'false' solo si el sitio de Argentina deja de estar en produccion.", sensitive: false, requiredFor: "GSC Argentina" },
  { name: "GA4_PROPERTY_ID_AR", group: "GA4", label: "Property Argentina", description: "GA4 property ID para argentina.dnamusic.edu.co.", sensitive: false, requiredFor: "Reportes GA4 Argentina" },
  { name: "DNA_SITE_US", group: "DNA Music", label: "GSC Estados Unidos", description: "Propiedad GSC de dnamusic.us.", sensitive: false, requiredFor: "GSC Estados Unidos" },
  { name: "DNA_DOMAIN_US", group: "DNA Music", label: "Dominio Estados Unidos", description: "Dominio para DataForSEO: dnamusic.us.", sensitive: false, requiredFor: "Competencia Estados Unidos" },
  { name: "DNA_CANONICAL_URL_US", group: "DNA Music", label: "URL canonica Estados Unidos", description: "URL principal para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_US", group: "DNA Music", label: "Location code Estados Unidos", description: "Codigo DataForSEO para Estados Unidos.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_US_PUBLISHED", group: "DNA Music", label: "Estados Unidos publicado", description: "Pon 'false' solo si el sitio de Estados Unidos deja de estar en produccion.", sensitive: false, requiredFor: "GSC Estados Unidos" },
  { name: "GA4_PROPERTY_ID_US", group: "GA4", label: "Property Estados Unidos", description: "GA4 property ID para dnamusic.us.", sensitive: false, requiredFor: "Reportes GA4 Estados Unidos" },
  { name: "DNA_SITE_CL", group: "DNA Music", label: "GSC Chile", description: "Propiedad GSC de dnamusic.cl.", sensitive: false, requiredFor: "GSC Chile" },
  { name: "DNA_DOMAIN_CL", group: "DNA Music", label: "Dominio Chile", description: "Dominio para DataForSEO: dnamusic.cl.", sensitive: false, requiredFor: "Competencia Chile" },
  { name: "DNA_CANONICAL_URL_CL", group: "DNA Music", label: "URL canonica Chile", description: "URL principal para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_CL", group: "DNA Music", label: "Location code Chile", description: "Codigo DataForSEO para Chile.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_CL_PUBLISHED", group: "DNA Music", label: "Chile publicado", description: "Pon 'false' solo si el sitio de Chile deja de estar en produccion.", sensitive: false, requiredFor: "GSC Chile" },
  { name: "GA4_PROPERTY_ID_CL", group: "GA4", label: "Property Chile", description: "GA4 property ID para dnamusic.cl.", sensitive: false, requiredFor: "Reportes GA4 Chile" },
  { name: "DNA_SITE_PE", group: "DNA Music", label: "GSC Peru", description: "Propiedad GSC de dnamusic.pe.", sensitive: false, requiredFor: "GSC Peru" },
  { name: "DNA_DOMAIN_PE", group: "DNA Music", label: "Dominio Peru", description: "Dominio para DataForSEO: dnamusic.pe.", sensitive: false, requiredFor: "Competencia Peru" },
  { name: "DNA_CANONICAL_URL_PE", group: "DNA Music", label: "URL canonica Peru", description: "URL principal para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_PE", group: "DNA Music", label: "Location code Peru", description: "Codigo DataForSEO para Peru.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_PE_PUBLISHED", group: "DNA Music", label: "Peru publicado", description: "Pon 'false' solo si el sitio de Peru deja de estar en produccion.", sensitive: false, requiredFor: "GSC Peru" },
  { name: "GA4_PROPERTY_ID_PE", group: "GA4", label: "Property Peru", description: "GA4 property ID para dnamusic.pe.", sensitive: false, requiredFor: "Reportes GA4 Peru" },
  { name: "DNA_SITE_ENCASA", group: "DNA Music", label: "GSC DNA Music en Casa", description: "Propiedad GSC de dnamusicencasa.com.", sensitive: false, requiredFor: "GSC DNA Music en Casa" },
  { name: "DNA_DOMAIN_ENCASA", group: "DNA Music", label: "Dominio DNA Music en Casa", description: "Dominio para DataForSEO: dnamusicencasa.com.", sensitive: false, requiredFor: "Competencia DNA Music en Casa" },
  { name: "DNA_CANONICAL_URL_ENCASA", group: "DNA Music", label: "URL canonica DNA Music en Casa", description: "URL principal para pruebas PageSpeed/GSC.", sensitive: false, requiredFor: "Diagnosticos" },
  { name: "DNA_LOCATION_ENCASA", group: "DNA Music", label: "Location code DNA Music en Casa", description: "Codigo DataForSEO, por defecto el de Colombia.", sensitive: false, requiredFor: "Rankings locales" },
  { name: "DNA_ENCASA_PUBLISHED", group: "DNA Music", label: "DNA Music en Casa publicado", description: "Pon 'false' solo si este sitio deja de estar en produccion.", sensitive: false, requiredFor: "GSC DNA Music en Casa" },
  { name: "GA4_PROPERTY_ID_ENCASA", group: "GA4", label: "Property DNA Music en Casa", description: "GA4 property ID para dnamusicencasa.com.", sensitive: false, requiredFor: "Reportes GA4 DNA Music en Casa" },
  ...
  { name: "GEMINI_API_KEY", group: "Video evidence", label: "Gemini API key", description: "Clave de Google AI Studio para analizar videos públicos de YouTube como evidencia no verificada para SEO/GEO.", sensitive: true, requiredFor: "video_evidence_analyze" },
  { name: "GEMINI_VIDEO_MODEL", group: "Video evidence", label: "Gemini video model", description: "Modelo Gemini para video. Default gemini-3.8-flash; cambia solo por un modelo que soporte video de YouTube.", sensitive: false, requiredFor: "video_evidence_analyze" },
  ...
  { name: "APIFY_ACTOR_GOOGLE_SEARCH", group: "Apify", label: "Google Search actor ID", description: "Actor ID para Google Search Results Scraper multifuente. Default: 'apify/google-search-scraper'. Soporta Google organic, AI Overviews, AI Mode, ChatGPT, Perplexity, Copilot y Gemini.", sensitive: false, requiredFor: "apify_google_search_multi_engine" },
  { name: "APIFY_ACTOR_LINK_PROSPECTING", group: "Apify", label: "Link prospecting actor ID", description: "Actor ID para link prospecting end-to-end. Default: 'apify/link-prospecting-tool'.", sensitive: false, requiredFor: "apify_link_prospecting_tool" },
  { name: "APIFY_ACTOR_META_BRAND_COLLAB", group: "Apify", label: "Meta brand collaboration actor ID", description: "Actor ID para branded content / collaborations desde Meta Ad Library. Default: 'apify/brand-collaboration-scraper'.", sensitive: false, requiredFor: "apify_meta_brand_collaboration" },
  { name: "APIFY_ACTOR_TRIPADVISOR", group: "Apify", label: "Tripadvisor actor ID", description: "Actor ID para Tripadvisor con lead enrichment y email verification. Default: 'maxcopell/tripadvisor'.", sensitive: false, requiredFor: "apify_tripadvisor_lead_enrichment" },
];
