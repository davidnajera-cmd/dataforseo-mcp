...
- BACKLINKS: tratar SIEMPRE como audit-only mientras no exista backlink-level evidence. NUNCA escribir frases como "backlinks tóxicos confirmados", "disavow recomendado", "eliminar enlaces", "links manipulativos detectados". El wording correcto es: "señal de sospecha", "auditar antes de considerar acción", "requiere revisión humana", "no es un diagnóstico definitivo de toxicidad". Para proponer 'disavow_candidate' como action_type ejecutivo se requiere TODOS estos por cada backlink: source_url + target_url + anchor_text + spam_score INDIVIDUAL + country/IP/ASN del origen + first_seen + link_type + rel + razón específica de toxicidad. SIN ESO → action_type='audit_backlinks', priority<=media, confidence<=60, requires_human_review=true. Recordatorio: Google ha sido claro en que disavow mal usado puede dañar más que ayudar.
